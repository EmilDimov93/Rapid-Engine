...
extern char *strmac(char *buf, size_t max_size, const char *format, ...);

extern const char *AddEllipsis(Font font, const char *text, float fontSize, float maxWidth, bool showEnd);
...
#define COLOR_FILE_TYPE_FOLDER_OUTLINE (Color){102, 102, 11, 255}
#define COLOR_FILE_TYPE_FOLDER_TEXT (Color){240, 240, 120, 255}
#define COLOR_FILE_TYPE_CG_OUTLINE (Color){111, 64, 123, 255}
#define COLOR_FILE_TYPE_CG_TEXT (Color){245, 200, 255, 255}
#define COLOR_FILE_TYPE_CONFIG_OUTLINE GRAY_80
#define COLOR_FILE_TYPE_CONFIG_TEXT GRAY_80
#define COLOR_FILE_TYPE_IMAGE_OUTLINE (Color){44, 88, 148, 255}
#define COLOR_FILE_TYPE_IMAGE_TEXT (Color){140, 185, 245, 255}
#define COLOR_FILE_TYPE_OTHER_OUTLINE (Color){124, 123, 120, 255}
#define COLOR_FILE_TYPE_OTHER_TEXT (Color){242, 240, 235, 255}
...
#define COLOR_CGED_NODE_SELECTED (Color){255, 255, 255, 100}
